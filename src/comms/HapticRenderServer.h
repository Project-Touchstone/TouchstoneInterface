...
public:
    HapticRenderServer(uint16_t port, size_t bufferSize);
    ~HapticRenderServer();
...
private:
    ...
    void handleClient(std::shared_ptr<DataProtocol> client, std::size_t bufferSize);
