...
void DRIFTPlex::attach(vector<DRIFTMotor*> motors, vector<Vector3d> homePoints, uint8_t numMotors) {
    this->motors = motors;
    ...
    for (int i = 0; i < numMotors; i++) {
        Vector3d newVec;
        newVec << 0, 0, 0;
        offsets.push_back(newVec);
    }
}

void DRIFTPlex::updateOffsets(vector<Vector3d> offsets) {
